...
from spread_core.protocols.dali.exceptions import IncompatibleFrame
...
class InstanceType(_AddressedInstance):
    ...
    #     if self._value in QueryInstanceType._types:
    #         return QueryInstanceType._types[self._value]
